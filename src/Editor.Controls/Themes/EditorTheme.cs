...
public class EditorTheme
{
    ...
    public static EditorTheme Nord { get; } = new()
    {
        ...
        LineNumberFg        = new SolidColorBrush(Color.FromRgb(0x6B, 0x77, 0x8D)),
        CurrentLineNumberFg = new SolidColorBrush(Color.FromRgb(0xEC, 0xEF, 0xF4)),
        ...
        TokenComment        = new SolidColorBrush(Color.FromRgb(0x7B, 0x88, 0xA1)),
        ...
        DiagnosticHint      = new SolidColorBrush(Color.FromRgb(0x7B, 0x88, 0xA1)),
